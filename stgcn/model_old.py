...
class STConvBlock(nn.Module):
    def __init__(self, A_hat, temporal_in_channels, spatial_in_channels,
        ...
        # self.in_channels = in_channels
        # self.out_channels = out_channels'A
        super().__init__()
        self.Kt_1  = Kt
        self.Kt_2 = Kt
        self.A_hat = A_hat
...
class STGCN(nn.Module):
    def __init__(
        ...
        self.block1 = STConvBlock(self.A_hat, num_features, spatial_in_channels, spatial_out_channels, temporal_out_channels, 3)
        self.block2 = STConvBlock(self.A_hat, temporal_out_channels, spatial_in_channels, spatial_out_channels, temporal_out_channels, 3)
        self.last_temporal = TemporalBlock(temporal_out_channels, temporal_out_channels, 22)
        self.fc = nn.Linear(64, out_timesteps)
